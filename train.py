...
# 超参数设置
batch_size = 8  # 在一次训练或推理中输入到模型中的样本数量  B
...
# 数据集
data_train = r'D:\vscode_code\Deep_learning\nanoGPT\data\train.bin'
data_val = r'D:\vscode_code\Deep_learning\nanoGPT\data\val.bin'
...
print("模型初始化中...")
# **model_args 的作用是将字典中的键值对作为关键字参数传递给 GPTConfig 的构造函数
...
def get_batch(split):
    ...
    # 随机选择 batch_size 个数据快的起始索引,就是随机生成从0到len(data)-block)size中的一个数,共batch_size个
    # 是类似于 [23, 67, 340, 500, 885] 这样的随机索引
